...
Feature: Affiliate Restaurants test Registered user

  Scenario Outline: Registered user makes booking in affiliated restaurant
    ...
    Then I have registered regular user with random email
