@Team-Infra
@Web-bat-tier-1
Feature: User Access frontdoor interface URL has valid refid [ excluded primary source], complete Reso Verify Attribution values
  ...
  @Attribution-frontdoor-Ref-Exclude-Source
  ...
  Scenarios:
    ...
    | .com   | http://www.opentable.com/frontdoor/singlerest.aspx?rid=(COM-POP2-RID)&mode=short&restref=(COM-POP2-RID)&ref=500 | 2        | 2 people | 7:00 PM | webdb-na-primary | automation/aut0m8er | 500   |

  @Region-EU @Domain-CO.UK
  Scenarios:
    | domain | Restref_URL                                                                                                          | days_fwd | party_sz | time  | database         | login               | refid |
    | .co.uk | http://www.opentable.co.uk/frontdoor/singlerest.aspx?rid=(COUK-POP2-RID)&mode=short&restref=(COUK-POP2-RID)&ref=2528 | 2        | 2 people | 19:00 | webdb-eu-primary | automation/aut0m8er | 2528  |
