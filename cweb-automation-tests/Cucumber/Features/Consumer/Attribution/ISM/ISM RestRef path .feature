...
@Web-bat-tier-0
@Web-bat-tier-1
Feature: User Access RestRef path ( ISM) makes Reso, Verify Attribution values
  ...
  Scenarios:
    ...
    | .com   | http://www.opentable.com/ism/singlerest.aspx?rid=(COM-POP2-RID) | 2        | 2 people | 7:00 PM | webdb-na-primary | automation/aut0m8er |

   @Region-EU @Domain-CO.UK
  Scenarios:
    | domain | ISM url                                                            | days_fwd | party_sz | time  | database         | login               |
    | .co.uk | http://www.opentable.co.uk/ism/singlerest.aspx?rid=(COUK-POP2-RID) | 2        | 2 people | 19:00 | webdb-eu-primary | automation/aut0m8er |
