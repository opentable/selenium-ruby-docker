...
@Web-bat-tier-0
@Web-bat-tier-1
Feature: User Access restaurant site ( uses ISM with referrer ID )makes Reso, Verify Attribution values
  ...
  @Attribution-ISM-InValidRef-Make

  Scenario Outline:  User Access restaurant site ( uses ISM with INvalisrefID )makes Reso, Verify Attribution values
  ...
  Scenarios:
    ...
    | .com   | http://www.opentable.com/ism/singlerest.aspx?rid=(COM-POP2-RID)&ref=2 | 2        | 2 people | 7:00 PM | webdb-na-primary | automation/aut0m8er |

  @Region-EU @Domain-CO.UK
  Scenarios:
    | domain | ISM url                                                                  | days_fwd | party_sz | time  | database         | login               |
    | .co.uk | http://www.opentable.co.uk/ism/singlerest.aspx?rid=(COUK-POP2-RID)&ref=2 | 1        | 2 people | 19:00 | webdb-eu-primary | automation/aut0m8er |
