...
Feature: User Access RestRef path ( single.aspx) URL has valid refid, complete Reso Verify Attribution values
  ...
  @Attribution-RestRef-Referrer-Excludedboth-Make
  ...
  Scenarios:
    ...
    | .com   | http://www.opentable.com/restaurant/profile/(COM-POP2-RID)/reserve?restref=(COM-POP2-RID)&ref=639 |   2      | 2 people | 7:00 PM | webdb-na-primary | automation/aut0m8er |

  @Region-EU @Domain-CO.UK
  Scenarios:
    | domain | Restref_URL                                                                                          | days_fwd | party_sz | time  | database         | login               |
    | .co.uk | http://www.opentable.co.uk/restaurant/profile/(COUK-POP2-RID)/reserve?restref=(COUK-POP2-RID)&ref=639 |    2     | 2 people | 19:00 | webdb-eu-primary | automation/aut0m8er |
